...
static const char *fonts[]          = { "Ubuntu:size=15", "Ubuntu Nerd Font:size=18" };
...
static const char *exitcmd[] = { "shutdown", "now", NULL };
static const char *restartcmd[] = { "shutdown", "-r", "now", NULL };

static const char *upvol[]   = { "pamixer", "--increase",   "2", NULL };
static const char *downvol[] = { "pamixer", "--decrease",   "2", NULL };
...
static Key keys[] = {
	...
	{ Mod1Mask|Mod4Mask,              XK_h,      incrgaps,       {.i = +1 } },
	{ Mod1Mask|Mod4Mask,              XK_l,      incrgaps,       {.i = -1 } },
	{ Mod1Mask|Mod4Mask|ShiftMask,    XK_h,      incrogaps,      {.i = +1 } },
	{ Mod1Mask|Mod4Mask|ShiftMask,    XK_l,      incrogaps,      {.i = -1 } },
	{ Mod1Mask|Mod4Mask|ControlMask,  XK_h,      incrigaps,      {.i = +1 } },
	{ Mod1Mask|Mod4Mask|ControlMask,  XK_l,      incrigaps,      {.i = -1 } },
